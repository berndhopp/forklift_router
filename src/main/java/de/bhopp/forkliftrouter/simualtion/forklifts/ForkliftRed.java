package de.bhopp.forkliftrouter.simualtion.forklifts;

import de.bhopp.forkliftrouter.domain.Location;
import de.bhopp.forkliftrouter.simualtion.VirtualForkliftBase;
import java.awt.*;
...
@Component
@Scope("singleton")
public class ForkliftRed extends VirtualForkliftBase {
